...
function Square(value) {
  ...
  return function render() {
    ...
    ++t;
    if (t >= (length * SAMPLE_RATE)) {
      return undefined
    };
    const sustain = t < length * 0.9 ? 1 : Math.pow(decay, t);
...
const bolero32: Voice = {
  gen: Square,
  notes: genNotes(
    '39~6,38~1,39~1,41~1,39~1,38~1,36~1,39~2,39~1,36~1,39~6,38~1,39~1,36~1,34~1,31~1,32~1,34~9,32~1,31~1,29~1,31~1,32~1,34~1,36~1,34~9,36~1,38~1,36~1,34~1,32~1,31~1,29~1,31~1,29~1,27~4,27~1,29~1,31~1,32~1,29~4,34~17,41~7,39~1,38~1,36~1,38~1,39~1,41~1,39~1,38~3,39~1,38~1,36~1,39~1,38~1,36~1,32~3,32~1,32~1,32~1,36~1,39~1,36~1,38~1,34~1,32~2,32~1,32~1,32~1,36~1,38~1,34~1,36~1,32~1,29~2,29~1,27~1,29~6,29~1'
  )
};
...
const processNote = (t: number, playbackRate: number, voices: Voice[]) => {
  ...
  for (let voice of voices) {
    ...
    for (let noteIndex = 0; noteIndex < voice.notes.length; noteIndex++) {
      ...
      const noteDuration = note.length * SAMPLE_RATE / 4;
